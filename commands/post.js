const { getConfessionNumber, getConfessionByConfessionId, addConfessionAndUpdate, addConfession, updateConfessionNumber } = require("../utils/config");
const { confessionsChannelId } = require("../config.json");
